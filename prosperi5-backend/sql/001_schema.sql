-- ============================================================
-- PROSPERi5 Careers — MySQL schema (Hostinger / phpMyAdmin)
-- Run this first in phpMyAdmin → SQL tab (select your DB)
-- ============================================================
-- Charset/collation chosen for emoji-safe UTF-8 and Hostinger defaults.

SET NAMES utf8mb4;
SET time_zone = '+00:00';

-- ------------------------------------------------------------
-- Admins (JWT login for careers admin panel)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Job applications (ready for future use; optional from website)
-- ------------------------------------------------------------
